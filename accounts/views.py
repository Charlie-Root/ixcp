...
from .forms import (
    ...
    ResendActivationCodeForm, ResendActivationCodeViaEmailForm, ChangeProfileForm, ProfileForm, ChangeEmailForm,
)
...
class ChangeProfileView(LoginRequiredMixin, FormView):
    ...
    def get_initial(self):
        ...
        initial['company_name'] = user.profile.company_name

        return initial
    
    def post(self, request):
        post_data = request.POST or None
        user_form = ChangeProfileForm(post_data, instance=request.user)
